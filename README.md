...
Shelly 1L       | `http://shellyip/ota?url=http://dl.dasker.eu/firmware/mg2tasmota-Shelly1L.zip`      | **not yet available, only flash if you a perfectly certain about what you are doing**
...
Shelly Uni      | `http://shellyip/ota?url=http://dl.dasker.eu/firmware/mg2tasmota-ShellyUni.zip`     | **not yet available, only flash if you a perfectly certain about what you are doing**
